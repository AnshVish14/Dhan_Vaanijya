...
import com.dhanvaanijya.data.EnterKey;
...
public class Dashboard extends JFrame {
    ...
    String[] menu = {
        "HOME", "Stockpredict", "EnterKey", "stocklistpanel",
    ...
    JPanel titleBar = new JPanel() {
        ...
        protected void paintComponent(Graphics g) {
            ...
            g2d.setPaint(new GradientPaint(0, 0, new Color(30, 144, 255),
                                           getWidth(), getHeight(),
    ...
    for (String label : menu) {
        ...
        button.addActionListener(e -> {
            switch (label) {
                ...
                case "EnterKey": CARD.show(mainPanel, "EnterKey"); break;
    ...
    // ----- Main Panel (must be created BEFORE adding anything to it) -----
    mainPanel = new JPanel(CARD);
    mainPanel.setBackground(Color.WHITE);

    JPanel homePanel = new JPanel(new BorderLayout());
    JLabel welcome = new JLabel(
        "<html><center><h1>Welcome to <font color='#1e90ff'>DHAN VAANIJYA</font></h1><p>The prediction tool for the traders.</p></center></html>",
    ...
    mainPanel.add(new EnterKey(), "EnterKey"); // ✅ Now safe
